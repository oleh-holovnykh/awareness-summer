    ...
    return (
      <>
        ...
        <div className='text-center mb-2'>
          <div className='mb-2'>
            <b>Передплата за інтенсив Awareness 2025:</b>
            <br />
            €100 = {Math.round(100 * euroRate!.rateSell)} грн
          </div>
          <div className='mb-2'>

          <NavLink to="/payment" className={getLinkClass} style={{ display: 'none' }}>
            <button
          ...
          <NavLink to="/schedule" className={getLinkClass} style={{ display: 'none' }}>
            <button
